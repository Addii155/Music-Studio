...
const Player = () => {
  ...
  return (
    ...
    //   </div>
    // </div>
    <div className="fixed bottom-0 left-0 right-0 w-full p-4 bg-white dark:bg-black dark:border-2 dark:border-gray-700 shadow-lg flex items-center justify-center z-50">
  <div className="w-full max-w-5xl mx-auto flex items-center">
    ...
    <div className="flex-1 pl-4">
      ...
      {/* Conditional rendering for ReactPlayer */}
      {song?.audio?.url && <CustomPlayer song={song} duration={setduration} />}
    </div>
  </div>
</div>
